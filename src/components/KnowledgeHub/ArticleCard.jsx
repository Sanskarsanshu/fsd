...
//     <div
//       className={`rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:scale-105 cursor-pointer ${
//         theme === 'dark' ? 'bg-zinc-900 border border-gray-800' : 'bg-white'
//       }`}
//       style={{ animation: `slideUp 0.5s ease-out ${index * 0.1}s backwards` }}
//       onClick={onRead}
//     >
...
//             : 'text-emerald-600 hover:text-emerald-700'
//         }`}>
//           {videoId ? '▶️ Watch Video →' : '📖 Read More →'}
//         </button>
//       </div>
//     </div>
//   );
  ...
  return (
    ...
    >
      ...
      <div className="p-4 sm:p-5 space-y-3">
        ...
        {/* Title */}
        <h3 className={`text-base sm:text-lg font-bold line-clamp-2 min-h-[3rem] ${
